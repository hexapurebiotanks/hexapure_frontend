    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mt-5">
        ...
        <motion.div variants={leftColumnVariants}>
          ...
          <motion.h2
            variants={itemVariants}
            className="text-text-dark text-4xl font-bold mb-6"
          >
            Connect Now
          </motion.h2>
          <motion.p
          ...
          >
            For inquiries for advanced wastewater solutions. Reach out for
            eco-friendly, innovative products that redefine wastewater treatment
            standards.
          </motion.p>
