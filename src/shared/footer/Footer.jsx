...
const renderLink = (item) => {
  ...
  const isExternalFile = (href) =>
    href.includes(".pdf") || href.startsWith("http");
  ...
  <footer className="bg-[#2A2A2A] text-white py-12 md:py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-12 pb-10 border-b border-[#333333]">
        ...
        <div className="col-span-1 md:col-span-4 order-1">
          ...
          <p className="text-[#CCCCCC] text-sm mb-6 md:pr-8">
            Leaders in eco-friendly wastewater solutions. Pioneering innovation,
            quality, and community engagement for sustainable futures.
          </p>

          {/* NEW: Contact Details Added Here */}
          <div className="space-y-2 text-sm text-[#CCCCCC]">
            <p>
              Address: Edaiyanvillai, Santhaiyadi Post, Kanyakumari District -
              629703
            </p>
            <p>
              <a
                href="tel:+918903488003"
                className="hover:text-[#2E8B57] transition-colors cursor-pointer"
              >
                Tel: +91 8903488003
              </a>
            </p>
            <p>
              <a
                ...
                className="hover:text-[#2E8B57] transition-colors cursor-pointer"
              >
                Email: hexapurebiotanks@gmail.com
              </a>
            </p>
          </div>
        ...
        <div className="col-span-1 xs:col-span-6 md:col-span-2 order-3">
          <h2 className="text-white font-semibold text-lg mb-4">Products</h2>
      ...
      <div className="pt-6 text-center text-[#CCCCCC] text-xs">
        Copyright © {currentYear} Hexapure. All rights reserved. Powered by
        Hexapure.
      </div>
    </div>
  </footer>
